        ...
        <div id="sideBar" class="sideBar">
            ...
            <button class="localisation-btn" id="localisation-btn" onclick="myFunctionSideBar2()"><img src="Logos/localisation.png"><a>Localisation</a></button>
              <div class="localisation-container" id="localisation-container">
                <button class="france" id="btnFrance" onclick="self.location.href='localisation_folklore/ville.php?id=France'"><img src="Logos/France.png"><a>France</a></button>
                <button class="belgique" id="btnBelgique" onclick="self.location.href='localisation_folklore/ville.php?id=Belgique'"><img src="Logos/Belgique.png"><a>Belgique</a></button>
              </div>
              ...
              <div class="folklore-container" id="folklore-container">
                <button class="faluche" id="btnFaluche" onclick="self.location.href='localisation_folklore/couvre_chef.php?id=Faluche'"><img src="Logos/Faluche.png"><a>Faluche</a></button>
                <button class="calotte" id="btnCalotte" onclick="self.location.href='localisation_folklore/couvre_chef.php?id=Calotte'"><img src="Logos/Calotte.png"><a>Calotte</a></button>
                <button class="penne" id="btnPenne" onclick="self.location.href='localisation_folklore/couvre_chef.php?id=Penne'"><img src="Logos/Penne.png"><a>Penne</a></button>
              </div>
            </div>
            ...
            <div class="separateur" id="s1"></div>
              ...
              <div class="calendrier-container" id="calendrier-container">
                ...
                <button class="ordinesque" id="btnOrdre" onclick="self.location.href='localisation_folklore/ville.php?id=Ordinesque'"><img src="Logos/Belgique.png"><a>Ordinesque</a></button>
              </div>
              ...
              <div class="insignes-container" id="insignes-container">
                <button class="congres" id="btnCongres" onclick="self.location.href='localisation_folklore/ville.php?id=Congrès'"><img src="Logos/France.png"><a>Code National Faluche</a></button>
                <button class="ordinesque" id="btnOrdre" onclick="self.location.href='localisation_folklore/ville.php?id=Ordinesque'"><img src="Logos/Belgique.png"><a>Usage en Belgique</a></button>
              </div>
              ...
              <div class="codes-container" id="codes-container">
                <button class="congres" id="btnCongres" onclick="self.location.href='localisation_folklore/ville.php?id=Congrès'"><img src="Logos/France.png"><a>Français</a></button>
                <button class="ordinesque" id="btnOrdre" onclick="self.location.href='localisation_folklore/ville.php?id=Ordinesque'"><img src="Logos/Belgique.png"><a>Belge</a></button>
              </div>
              ...
              <div class="revisions-container" id="revisions-container">
                <button class="congres" id="btnCongres" onclick="self.location.href='localisation_folklore/ville.php?id=Congrès'"><img src="Logos/France.png"><a>Révision code</a></button>
                <button class="ordinesque" id="btnOrdre" onclick="self.location.href='localisation_folklore/ville.php?id=Ordinesque'"><img src="Logos/Belgique.png"><a>Lecture de Calotte</a></button>
              </div>
